# Quick HDRI Controls | Cycles | Octane | V-Ray | v2.8.7
![Blender Version](https://img.shields.io/badge/Blender-4.0.0-green.svg)
![QHDRIC Version](https://img.shields.io/badge/QHDRIC-2.8.7-blue.svg)

### !!! RESTART BLENDER AT LEAST TWICE FOR v2.8.7 !!! ###
