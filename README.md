# Quick HDRI Controls | Cycles | Octane | V-Ray | v2.9.3
![Blender Version](https://img.shields.io/badge/Blender-4.0.0-green.svg)
![QHDRIC Version](https://img.shields.io/badge/QHDRIC-2.9.3-blue.svg)

### RESTART BLENDER AT LEAST TWICE FOR v2.9.3 (until 2.9.5) ###
